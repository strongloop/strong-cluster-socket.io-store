...
Thank you for your interest in `strong-cluster-socket.io-store`, an open source project
administered by StrongLoop.

Contributing to `strong-cluster-socket.io-store` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-cluster-socket.io-store)
